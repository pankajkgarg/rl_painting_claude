...
pip install -q "vllm==0.27.1"                                   # brings torch 2.13+cu130
pip install -q "trl==1.12.0" peft playwright open_clip_torch sentencepiece hf_transfer flash-linear-attention
pip install -q -U transformers                                  # TRL 1.12 targets transformers 5.x (no unsloth: it pins trl<=0.24)
...
python -c "from trl.trainer.grpo_trainer import GRPOTrainer; import vllm; print('TRL_IMPORT_OK')"
